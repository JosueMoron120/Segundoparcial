...
export const createUser=async(req,res)=>{
    try {
        const{username,password, idrol, idempleado}=req.body;
        const password2=await helpers.encryptPassword(password);
        await pool.query('insert into usuario(username,password, idrol, idempleado)values($1,$2, $3, $4)',[username,password2, idrol, idempleado]);
